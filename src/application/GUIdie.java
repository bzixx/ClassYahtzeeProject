...
public class GUIdie extends Button {
	...
	// Initial Creation of ImageView of the GUIdie, this will be changed later in
	// the code.
	...
	/*
	 * public void setSide() { This Was created initially in UML but not needed in
	 * our program. }
	 */
	...
	/**
	 * Will force an unlock of a GUIdie. Will be used when resetting dice for
	 * another roll.
	 * 
	 */
	...
	/**
	 * 
	 * Once a GUIdie is pressed this processButtonPress method will toggle the lock
	 * of the GUIdie.
	 * 
